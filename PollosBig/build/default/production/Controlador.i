...
unsigned char bombillaCar1[8] = { 0x0E, 0x11, 0x11, 0x11, 0x0E, 0x0E, 0x00, 0x00};
unsigned char bombillaCar2[8] = { 0x0E, 0x11, 0x11, 0x11, 0x0E, 0x0E, 0x00, 0x00};
unsigned char bombillaCar3[8] = { 0x0E, 0x11, 0x11, 0x11, 0x0E, 0x0E, 0x00, 0x00};
unsigned char bombillaCar4[8] = { 0x0E, 0x11, 0x11, 0x11, 0x0E, 0x0E, 0x00, 0x00};
...
void main() {
    ...
    while (1) {
        ...
        LCD_Custom_Char(1,bombillaCar1);
        LCD_Custom_Char(1,bombillaCar2);
        LCD_Custom_Char(1,bombillaCar3);
        ...
        if (hour >= 19 || hour <=6) {
            ...
            var_RH_Integral = DHT11_ReadData();
            var_RH_Decimal = DHT11_ReadData();
            var_T_Integral = DHT11_ReadData();
            var_T_Decimal = DHT11_ReadData();
